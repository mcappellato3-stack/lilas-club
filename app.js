...
const demoProfiles=[
{"id":"demo1","name":"Marina","age":27,"state":"SP","city":"São Paulo","district":"Jardins","category":"Acompanhantes","gender":"Mulheres","text":"Perfil demonstrativo para teste do Lilás Club.","verified":true,"image":"assets/model-11.jpg","gallery":["assets/model-11.jpg","assets/model-01.jpg","assets/model-06.jpg","assets/model-13.jpg"],"video":"assets/demo-video.mp4","prices":{"min15":90,"min30":160,"hour1":290}},
{"id":"demo2","name":"Bianca","age":25,"state":"RJ","city":"Rio de Janeiro","district":"Copacabana","category":"Acompanhantes","gender":"Mulheres","text":"Perfil demonstrativo para teste do Lilás Club.","verified":true,"image":"assets/model-12.jpg","gallery":["assets/model-12.jpg","assets/model-02.jpg","assets/model-07.jpg","assets/model-14.jpg"],"video":"assets/demo-video.mp4","prices":{"min15":120,"min30":190,"hour1":350}},
{"id":"demo3","name":"Carla","age":29,"state":"MG","city":"Belo Horizonte","district":"Savassi","category":"Acompanhantes","gender":"Mulheres","text":"Perfil demonstrativo para teste do Lilás Club.","verified":false,"image":"assets/model-13.jpg","gallery":["assets/model-13.jpg","assets/model-03.jpg","assets/model-08.jpg","assets/model-15.jpg"],"video":"assets/demo-video.mp4","prices":{"min15":80,"min30":145,"hour1":250}},
{"id":"demo4","name":"Luna","age":26,"state":"PR","city":"Curitiba","district":"Batel","category":"Acompanhantes","gender":"Mulheres","text":"Perfil demonstrativo para teste do Lilás Club.","verified":true,"image":"assets/model-14.jpg","gallery":["assets/model-14.jpg","assets/model-04.jpg","assets/model-09.jpg","assets/model-11.jpg"],"video":"assets/demo-video.mp4","prices":{"min15":110,"min30":180,"hour1":320}},
{"id":"demo5","name":"Maya","age":31,"state":"BA","city":"Salvador","district":"Barra","category":"Acompanhantes","gender":"Mulheres","text":"Perfil demonstrativo para teste do Lilás Club.","verified":true,"image":"assets/model-15.jpg","gallery":["assets/model-15.jpg","assets/model-05.jpg","assets/model-10.jpg","assets/model-12.jpg"],"video":"assets/demo-video.mp4","prices":{"min15":100,"min30":170,"hour1":300}},
{"id":"demo6","name":"Isabela","age":24,"state":"DF","city":"Brasília","district":"Asa Sul","category":"Acompanhantes","gender":"Mulheres","text":"Perfil demonstrativo para teste do Lilás Club.","verified":true,"image":"assets/model-06.jpg","gallery":["assets/model-06.jpg","assets/model-11.jpg","assets/model-02.jpg","assets/model-14.jpg"],"video":"assets/demo-video.mp4","prices":{"min15":130,"min30":210,"hour1":390}},
{"id":"demo7","name":"Camila","age":28,"state":"SC","city":"Florianópolis","district":"Centro","category":"Acompanhantes","gender":"Mulheres","text":"Perfil demonstrativo para teste do Lilás Club.","verified":true,"image":"assets/model-07.jpg","gallery":["assets/model-07.jpg","assets/model-12.jpg","assets/model-03.jpg","assets/model-15.jpg"],"video":"assets/demo-video.mp4","prices":{"min15":95,"min30":155,"hour1":280}},
{"id":"demo8","name":"Júlia","age":30,"state":"PE","city":"Recife","district":"Boa Viagem","category":"Acompanhantes","gender":"Mulheres","text":"Perfil demonstrativo para teste do Lilás Club.","verified":false,"image":"assets/model-08.jpg","gallery":["assets/model-08.jpg","assets/model-13.jpg","assets/model-04.jpg","assets/model-11.jpg"],"video":"assets/demo-video.mp4","prices":{"min15":85,"min30":150,"hour1":265}},
{"id":"demo9","name":"Amanda","age":27,"state":"GO","city":"Goiânia","district":"Setor Bueno","category":"Acompanhantes","gender":"Mulheres","text":"Perfil demonstrativo para teste do Lilás Club.","verified":true,"image":"assets/model-09.jpg","gallery":["assets/model-09.jpg","assets/model-14.jpg","assets/model-05.jpg","assets/model-12.jpg"],"video":"assets/demo-video.mp4","prices":{"min15":105,"min30":175,"hour1":315}},
{"id":"demo10","name":"Sofia","age":26,"state":"CE","city":"Fortaleza","district":"Meireles","category":"Acompanhantes","gender":"Mulheres","text":"Perfil demonstrativo para teste do Lilás Club.","verified":true,"image":"assets/model-10.jpg","gallery":["assets/model-10.jpg","assets/model-15.jpg","assets/model-01.jpg","assets/model-13.jpg"],"video":"assets/demo-video.mp4","prices":{"min15":115,"min30":185,"hour1":335}}
];
...
function render(){
  ...
  $("#cards").innerHTML=rows.map(p=>`<article class="card" data-id="${p.id}">
    <div class="card-media">${p.image?`<img src="${p.image}" alt="${p.name}">`:`<span>Foto do perfil<br>${p.name}</span>`}${p.image?'<span class="media-watermark">www.lilassclub.com.br</span>':''}${p.video?'<span class="video-indicator" title="Perfil com vídeo">▶</span>':''}</div>
...
function openDemoProfile(id){
  ...
  const thumbs=gallery.map((src,i)=>`<button class="demo-thumb ${i===0?'active':''}" data-demo-img="${escText(src)}"><img src="${escText(src)}" alt=""></button>`).join('');
  document.getElementById('profileDemoContent').innerHTML=`<div class="demo-profile-grid"><div><div class="demo-main-media"><img id="demoMainImage" src="${escText(gallery[0]||p.image||'')}" alt="${escText(p.name)}"><span class="media-watermark large">www.lilassclub.com.br</span></div><div class="demo-thumbs">${thumbs}</div>${p.video?`<div class="demo-video-wrap"><video controls playsinline preload="metadata" src="${escText(p.video)}"></video><span class="media-watermark video-mark">www.lilassclub.com.br</span></div>`:''}</div><div class="demo-profile-info"><small>PERFIL DEMONSTRATIVO</small><h2>${escText(p.name)}${p.age?`, ${p.age}`:''} ${p.verified?'<span class="verified">✓</span>':''}</h2><p>${escText([p.district,p.city,p.state].filter(Boolean).join(' • '))}</p><div class="demo-rates"><div><span>15 minutos</span><b>${moneyBR(prices.min15)}</b></div><div><span>30 minutos</span><b>${moneyBR(prices.min30)}</b></div><div><span>1 hora</span><b>${moneyBR(prices.hour1)}</b></div></div><p class="demo-copy">${escText(p.text)}</p><div class="demo-only">DEMO • dados e valores fictícios para teste</div></div></div>`;
  document.querySelectorAll('[data-demo-img]').forEach(b=>b.onclick=()=>{document.getElementById('demoMainImage').src=b.dataset.demoImg;document.querySelectorAll('[data-demo-img]').forEach(x=>x.classList.remove('active'));b.classList.add('active')});
